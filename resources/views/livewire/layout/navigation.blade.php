        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 lg:-my-px lg:ms-10 lg:flex">
                    ...
                    <x-nav-link :href="route('post-create')" :active="request()->routeIs('post-create')" wire:navigate>
                        {{ __('Create Post') }}
                    </x-nav-link>
                    <x-nav-link :href="route('category-tag')" :active="request()->routeIs('category-tag')" wire:navigate>
                        {{ __('Category/Tags') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin-posts')" :active="request()->routeIs('admin-posts')" wire:navigate>
                        {{ __('Admin Posts') }}
                    </x-nav-link>
                    <x-nav-link :href="route('blog')" :active="request()->routeIs('blog')" wire:navigate>
                        {{ __('Posts/Blog') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin-shop')" :active="request()->routeIs('admin-shop')" wire:navigate>
                        {{ __('Shop') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin-uploads')" :active="request()->routeIs('admin-uploads')" wire:navigate>
                        {{ __('Uploads') }}
                    </x-nav-link>
                </div>
            </div>
