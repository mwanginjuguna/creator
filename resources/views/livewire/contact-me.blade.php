    ...
    <div class="lg:px-6 md:pl-10">
        ...
        <form wire:submit="sendMessage" class="text-sm md:text-base">
            <div class="mt-3">
                ...
                @error('form.name') <p class="text-red-600 text-sm xl:text-base">{{ $errors['name'] }}</p> @enderror
            </div>
            ...
            <div class="mt-3">
                ...
                @error('form.email') <p class="text-red-600 text-sm xl:text-base">{{ $errors['email'] }}</p> @enderror
            </div>
            ...
            <div class="mt-3">
                ...
                @error('form.message') <p class="text-red-600 text-sm xl:text-base">{{ $errors['message'] }}</p> @enderror
            </div>
