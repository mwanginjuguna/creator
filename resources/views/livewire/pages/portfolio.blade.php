<div id="portfolio" class="container mx-auto mt-10 lg:mt-20 py-3 lg:py-8">
    ...
    <div class="flex flex-col gap-y-4 pb-3 lg:pb-8">
        ...
        <p>
            Explore our work. More projects are available on my <a class="text-creator-primary hover:text-orange-500 font-semibold hover:underline" href="https://github.com/mwanginjuguna">GitHub Profile</a> .
        </p>
    </div>
